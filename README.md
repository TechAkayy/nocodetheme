...
Create a new `nocodetheme` themes folder, for eg, `/Users/techakayy/Local Sites/nocodetheme/app/public/wp-content/themes/nocodetheme`.
...
Then, use your username and application password in Pinegrow via menu `Wordpress > Theme/Plugin Settings`. Test API access to ensure it works. 
